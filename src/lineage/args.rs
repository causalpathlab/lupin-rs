//! `lupin lineage` command-line surface.
//!
...
// The advanced tuning knobs carry `hide_short_help` so `lupin lineage -h` shows only the
...
pub struct LineageArgs {
    ...
    #[arg(
        ...
        long_help = "Annotate each trajectory node with a cell type,\n\
                     by term over-representation — the `lupin annotate --method projection` core —\n\
    ...
    #[arg(
        ...
        long_help = "Optional.\n\
                     ...
                     as in `lupin annotate --method projection`.\n\
