...
/// is not an observation to fit. (`lupin dyn-assoc` separately drops unplaceable cells at its
/// input boundary — see [`super::io::load_lineage`] — but the tests here call this
